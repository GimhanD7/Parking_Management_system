...
export default function FeedbackList() {
    ...
    const setData = (data) => {
        ...
        let { _id, course, student, feedback,response } = data;
    ...
    const exportFeedbacks = () => {
        ...
        const headers = [["Section number", "Vehicale Number", "Add Time","Payment"]];
                        ...
                        <div className='items-center overflow-hidden'>
                            <div class="grid grid-cols-1 gap-4 content-start">
                                <table className=''>
                                    ...
                                    <tr>
                                        <th className='drop-shadow-md'><h1>Vehicale List</h1></th>
                                        <td className='flex justify-end gap-2'>
                                            ...
                                            <div class="flex justify-end sm:flex-row sm:text-left sm:justify-end">
                                                <input
                                                    ...
                                                    icon='search'
                                                    placeholder='Filter By Vehicale'
                                ...
                                <table className='w-full text-sm text-left text-gray-500 dark:text-gray-400'>
                                    ...
                                    <thead className='p-5 text-xs text-gray-700 uppercase border bg-gray-50 dark:bg-gray-700 dark:text-gray-400'>
                                        <tr>
                                            ...
                                            <th className="p-2 tbhead"><h1>Vehicale Number</h1> </th>
                                            <th className="p-2 tbhead"><h1>Duration</h1></th>
                                            <th className="p-2 tbhead"><h1>Add Time</h1></th>
                                            <th className="p-2 tbhead"><h1>Payment</h1></th>
