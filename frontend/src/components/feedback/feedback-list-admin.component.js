...
export default function FeedbackListAdmin() {
    ...
    const student = {
        createdAt: new Date() // Replace this with the actual createdAt date of the student
    };
    ...
    const exportFeedbacks = () => {
        ...
        const title = "Vehicale List Report ";
        const headers = [["Section ", "vehicle number",  "Dste and time","Payment"]];
                        ...
                        <div className='items-center overflow-hidden'>
                            <div class="grid grid-cols-1 gap-4 content-start">
                                <table className=''>
                                    ...
                                    <tr>
                                        <th className='drop-shadow-md'><h1>Vehicle List</h1></th>
                                        <td className='flex justify-end gap-2'>
                                            ...
                                            <div class="flex justify-end sm:flex-row sm:text-left sm:justify-end">
                                                <input
                                                    ...
                                                    icon='search'
                                                    placeholder='Filter By vehicale section'
                            ...
                            <div className='relative grid content-start grid-cols-1 gap-4 overflow-x-auto shadow-md sm:rounded-lg'>
                                <table className='w-full text-sm text-left text-gray-500 dark:text-gray-400'>
                                    ...
                                    <thead className='p-5 text-xs text-gray-700 uppercase border bg-gray-50 dark:bg-gray-700 dark:text-gray-400'>
                                        <tr>
                                            <th className="p-2 border-black tbhead "><h1>Section Number</h1></th>
                                            <th className="p-2 tbhead"><h1>Vehical Number</h1></th>
                                            <th className="p-2 tbhead"><h1>Time duration</h1></th>

                                            <th className="p-2 tbhead"><h1>Date & Time</h1></th>
                                            <th className="p-2 text-center tbhead"><h1>Bill amount</h1></th>
                                            <th className="p-2 text-center tbhead"><h1>Check out</h1></th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        {searchInput.length > 1 ? (
                                            ...
                                            APIData.map((data) => {
                                                return (
                                                    <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
                                                        <td className='px-6 py-4'><h3>{data.course}</h3></td>
                                                        <td className='px-6 py-4'><h3>{data.student}</h3></td>
                                                        <td className='px-6 py-4'><h3>{formatDistanceToNow(new Date(data.createdAt), { addSuffix: true })}</h3></td>
                                                        <td className='px-6 py-4'><h3>{data.feedback}</h3></td>
                                                        <td className='px-6 py-4'><h3>{data.response}</h3></td>
                                                        <td className='px-6 py-4'>
                                                            <div class="flex justify-center">
                                                                <div class="">
